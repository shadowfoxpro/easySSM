...
public class CheckUtil {
    private static final String VERIFICATION_CODE = "verificationCodeValue";
    private static final String REG_NUMBER = "^[0-9]+$";
    private static final String REG_NUMBER_LETTER_CN_CHAR = "^[A-Za-z0-9_\\u4e00-\\u9fa5]+$";
    private static final String REG_PASSWORD = "^[A-Za-z0-9~!@#$%]+$";
    private static final String REG_EMAIL = "^([a-zA-Z0-9]+[_|\\_|\\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\\_|\\.]?)*[a-zA-Z0-9]+\\.[a-zA-Z]{2,3}$";
    private static final String REG_MOBILE = "^0?(1)[0-9]{10}$";
    ...
    public static boolean checkBankNum(String bankNum) {
        if ("".equals(bankNum) || bankNum.length() < 12 || bankNum.length() > 20
                || !bankNum.matches(REG_NUMBER)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean checkBranchName(String branchName) {
        if ("".equals(branchName) || branchName.length() < 2 || branchName.length() > 30
                || !branchName.matches(REG_NUMBER_LETTER_CN_CHAR)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean checkAreaCode(String areaCode) {
        if ("".equals(areaCode) || areaCode.length() < 3 || areaCode.length() > 6
                || !areaCode.matches(REG_NUMBER)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean checkNickName(String nickName) {
        if ("".equals(nickName) || nickName.length() < 2 || nickName.length() > 11
                || !nickName.matches(REG_NUMBER_LETTER_CN_CHAR)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean checkPassword(String password) {
        if ("".equals(password) || password.length() < 6 || password.length() > 15
                || !password.matches(REG_PASSWORD)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean checkEmail(String email) {
        if ("".equals(email) || email.length() > 40 || !email.matches(REG_EMAIL)) {
            return true;
        }
        return false;
    }
     ...
     *
     * @param mobile
     * @return 格式不匹配返回true 匹配返回false
     */
    public static boolean checkMobile(String mobile) {
        if (mobile == null || "".equals(mobile) || !mobile.matches(REG_MOBILE)) {
            return true;
        }
        return false;
    }

    public static Double checkAndReplace(Double d) {
        return (d == null ? 0.0 : d);
    }
     ...
     * @return
     */
    public static boolean isSensitiveWord(String content) {
        String words = PublicCode.systemMap.get("sensitive");
